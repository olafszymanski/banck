<template>
  <div class="flex flex-col items-center space-y-10 p-2 xs:p-4 text-chinese-black bg-white rounded-10px shadow-lg">
    ...
    <Button class="p-1 w-11/12 xs:w-1/2 sm:w-1/3" value="Transfer" :outline="true"/>
  </div>
</template>
