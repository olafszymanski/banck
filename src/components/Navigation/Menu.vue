<template>
  <ul v-if="!$store.state.loggedIn" class="flex">
    <MenuItem :index="0" class="flex space-x-2 sm:space-x-0" @click="itemClicked">
      <svg class="w-8 h-8" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M11 16l-4-4m0 0l4-4m-4 4h14m-5 4v1a3 3 0 01-3 3H6a3 3 0 01-3-3V7a3 3 0 013-3h7a3 3 0 013 3v1"></path></svg>
      <div class="sm:hidden">Log in</div>
    </MenuItem>
    <MenuItem :index="1" class="flex space-x-2 sm:space-x-0" @click="itemClicked">
      ...
      <div class="sm:hidden">Sign up</div>
    </MenuItem>
  </ul>
  <ul v-else class="flex">
    <MenuItem :index="2" class="flex space-x-2 sm:space-x-0" @click="itemClicked">
      ...
      <div class="sm:hidden">Account</div>
    </MenuItem>
    <MenuItem :index="3" class="flex space-x-2 sm:space-x-0" @click="itemClicked">
      ...
      <div class="sm:hidden">Settings</div>
    </MenuItem>
    <MenuItem :index="4" class="flex space-x-2 sm:space-x-0" @click="itemClicked">
      ...
      <div class="sm:hidden">Log out</div>
    </MenuItem>
  </ul>
</template>
